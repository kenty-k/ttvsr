...
parser = argparse.ArgumentParser(description='Download REDS dataset from google drive to /misc/dl001/dataset', allow_abbrev=False)
...
# 保存先ディレクトリを '/misc/dl001/dataset' に設定
root_dir = '/misc/dl001/dataset'
